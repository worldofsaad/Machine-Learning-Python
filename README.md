...
## 1. Regression
- **Simple Linear Regression**:  Fuel Consumption Prediction Model using Simple Linear Regression
- **Multiple Linear Regression**:  Fuel Consumption Prediction Model using Multiple Linear Regression
